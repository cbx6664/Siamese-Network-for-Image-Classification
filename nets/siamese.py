...
from nets.resnet import myResNet50
...
def siamese(input_shape):
    ...
    encoded_image_1 = resnet_model.call(input_image_1)
    encoded_image_2 = resnet_model.call(input_image_2)

...
class Datasets(keras.utils.Sequence):
    def __init__(self, input_shape, lines, labels, batch_size, random, autoaugment_flag=True):
    ...
    def __len__(self):
        return math.ceil(len(self.train_lines) / float(self.batch_size))
